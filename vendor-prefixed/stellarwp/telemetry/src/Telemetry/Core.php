...
namespace Filter_AI\Vendor\StellarWP\Telemetry;

use Filter_AI\Vendor\StellarWP\ContainerContract\ContainerInterface;
use Filter_AI\Vendor\StellarWP\Telemetry\Admin\Admin_Subscriber;
use Filter_AI\Vendor\StellarWP\Telemetry\Admin\Resources;
use Filter_AI\Vendor\StellarWP\Telemetry\Contracts\Data_Provider;
use Filter_AI\Vendor\StellarWP\Telemetry\Data_Providers\Debug_Data;
use Filter_AI\Vendor\StellarWP\Telemetry\Events\Event_Subscriber;
use Filter_AI\Vendor\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use Filter_AI\Vendor\StellarWP\Telemetry\Exit_Interview\Template;
use Filter_AI\Vendor\StellarWP\Telemetry\Last_Send\Last_Send;
use Filter_AI\Vendor\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use Filter_AI\Vendor\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use Filter_AI\Vendor\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use Filter_AI\Vendor\StellarWP\Telemetry\Opt_In\Status;
use Filter_AI\Vendor\StellarWP\Telemetry\Telemetry\Telemetry;
use Filter_AI\Vendor\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \Filter_AI\Vendor\StellarWP\ContainerContract\ContainerInterface
	 */
