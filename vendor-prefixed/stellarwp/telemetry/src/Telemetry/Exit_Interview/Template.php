...
namespace Filter_AI\Vendor\StellarWP\Telemetry\Exit_Interview;
...
use Filter_AI\Vendor\StellarWP\Telemetry\Contracts\Template_Interface;
...
class Template implements Template_Interface {
	 ...
	 * @since 1.0.0
	 *
	 * @var \Filter_AI\Vendor\StellarWP\ContainerContract\ContainerInterface
	 */
	protected $container;
	 ...
	 * @since 1.0.0
	 *
	 * @param \Filter_AI\Vendor\StellarWP\ContainerContract\ContainerInterface $container The container.
	 */
